$(document).ready(function () {
  $().ready(function () {
    ...
    white_color = localStorage.getItem("white_color");
    if (white_color === true) {
    ...
    $(".switch-change-color input").on(
      ...
      function () {
        ...
        localStorage.setItem("white_color", white_color);
      }
    );
    ...
    $("#theme-switch").on('change',function () {
      ...
      if (white_color === true) {
        $("body").addClass("change-background");
        $("body").removeClass("white-content");
        $("#theme-switch input:checkbox").prop("checked", false);
        localStorage.setItem("white_color", false);
        $("body").removeClass("change-background");
      } else {
        $("body").addClass("change-background");
        $("#theme-switch input:checkbox").prop("checked", true);
        $("body").addClass("white-content");
        localStorage.setItem("white_color", true);
        $("body").removeClass("change-background");
